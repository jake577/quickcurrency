...
public class Bter extends AbstractExchange{
    //api documentation - https://bter.com/api
    private static String APIURL = "http://data.bter.com/api/1/ticker/";

    public Bter(DataLoadedListener listener, String nodeId, int exchangeId) {
